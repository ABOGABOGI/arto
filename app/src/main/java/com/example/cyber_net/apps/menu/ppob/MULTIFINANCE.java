...
public class MULTIFINANCE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multifinance);
        ButterKnife.bind(this);
        getSupportActionBar().setTitle("MULTIFINANCE");
        getSupportActionBar().setSubtitle("Bayar Tagihan MULTIFINANCE");
    ...
    private void load_data(){
        ...
        Call<PPOB> call = apiInterface.getPPOBlist(5);
        call.enqueue(new Callback<PPOB>() {
            ...
            public void onResponse(Call<PPOB> call, Response<PPOB> response) {
                ...
                SpinnerListAdapter adapter = new SpinnerListAdapter(MULTIFINANCE.this, R.layout.one_item_spinner, datalist);
    ...
    private void inquiry(){
        ...
        call.enqueue(new Callback<Inquiry>() {
            ...
            public void onResponse(Call<Inquiry> call, Response<Inquiry> response) {
                ...
                if(reffid==null){
                    Toast.makeText(MULTIFINANCE.this,"NOMOR PELANGGAN TIDAK DITEMUKAN",Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    Intent intent = new Intent(MULTIFINANCE.this, Detail_ppob.class);
